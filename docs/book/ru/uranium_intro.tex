...
\begin{example}{Rebasing объектов при помещении в базу}%
     {db_put_object/3}
...
Идентификаторы классов 10 и 89 можно расшифровать:
...
\verb|obj_rebase((object_v -> db_object_v), O1, O2)| 

(см. описание предиката obj_rebase в pldoc).
...
Ту же операцию можно использовать и для замены значения поля:
